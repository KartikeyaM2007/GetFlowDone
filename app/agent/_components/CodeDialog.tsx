  ...
  return (
    <>
      <Dialog open={isOpen && !showLanguageDialog} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl h-[700px] flex flex-col bg-[#050505] border-[#111111]/20 text-white shadow-[0_0_50px_rgba(0,0,0,0.8)]">
          <DialogHeader>
      ...
      <Dialog open={showLanguageDialog} onOpenChange={setShowLanguageDialog}>
        <DialogContent className="max-w-md bg-[#050505] border-[#111111]/20 text-white shadow-[0_0_50px_rgba(0,0,0,0.8)]">
          <DialogHeader>
